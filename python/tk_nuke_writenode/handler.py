...
class TankWriteNodeHandler(object):
    ...
    def __compute_render_path(self, node, is_proxy=False):
        ...
        # compute the render path:
        return self.__compute_render_path_from(node, render_template, width, height, output_name, colorspace_name)

    def __compute_render_path_from(self, node, render_template, width, height, output_name, colorspace_name):
        """
